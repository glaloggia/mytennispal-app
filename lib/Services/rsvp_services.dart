...
class RsvpServices {
  static Future<http.Response> create(BuildContext context, int playerId, int eventId) async {
  ...
  static Future<List<dynamic>> getAttendance(int eventId) async {
    ...
    final response = await http
        .get(Uri.parse(baseURL + 'attendance/' + eventId.toString()),headers: headers);
